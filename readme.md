...
1. Clone this repo:
   ...
   cd CloudMattingGAN
   ```
2. Here we only upload a small part of our dataset. The complete dataset can be downloaded from: 1) [Google Driver](); 2) [BaiduYun](https://pan.baidu.com/s/17Lfh5LpXrTsxkwFdoi_Jhw) (Key: 0626).
